...
summary: 此次代码差异主要涉及多个文档的更新与删除，包括新增图片和删除与自定义健康文本分析及情感分析相关的文档。这次修改的亮点包括新增了供用户参考的图片文件，显示了对Serp
  API连接密钥的更直观说明。同时，大量文档和图像被删除，可能会影响用户对服务的理解，尤其是自定义健康文本分析方面的关键指南。对此，用户可能需要迅速适应其他Azure
  AI语言服务，以确保现有项目的顺利过渡。整体来看，这次更新旨在优化文档结构，提高用户体验。
...
# Highlights
此代码差异主要涉及多个文档的更新与删除，同时涉及到部分图片的新增、替换和移除。以下是主要的亮点：

## 新特性
- 新增 `serp-connection-keys.png` 图片文件，为用户提供更直观的 Serp API 连接密钥视觉指导。

## 重大变更
- 删除了大量与自定义健康文本分析及情感分析项目相关的文档和图像，如 `overview.md` 和 `quickstart.md`。
- 多个教学图示和指导图像被移除，例如 `create-project.png`、`resource-sharing.png` 等。
- 移除了针对自定义情感分析的多个详细指导文件。
- 删除了 `serp-custom-connection-keys.png` 图像，可能影响到相关文档的完整性。

## 其他更新
- 修订了 `index.yml` 和某些概述文件，以更新索引内容或移除不再相关的部分。
- 更新了某些文档的发布时间，如 `prompt-flow.md` 和 `serp-api-tool.md`，反映了最新的编辑状态。

# 见解
此次代码差异展示了一系列关于自定义健康文本分析及情感分析文档的重大清理和重组，可能是为了优化文档结构或由于产品策略的调整。这一过程包括了对不再现行或过时内容的大量移除。对于自定义健康文本分析，涉及到的包括快速入门、项目设置、训练和调用 API 等多项关键指南文档的删除。特别是 `overview.md` 和 `glossary.md` 的删除，将直接影响用户对整个服务框架的了解。

这些移除可能会为当前用户制造不便，尤其是在缺少替代文档的情况下。这表明可能需要用户迅速适应其他 Azure AI 语言服务，或制定替代计划以确保他们现有项目的顺利过渡。而那些被视为 breaking change 的改动则意味着产品或服务部分已经过时，需要用户注意迁移方案。

与此同时，关于 SERP API 新增的图像资源，则显示了对文档信息表达的进一步细化。这种视觉表现的增强，有利于优化用户体验，尤其是对于新用户，通过更直观的图示帮助他们更快地掌握工具的使用。

在这种颠覆重塑的文档环境中，保证用户的顺利过渡和需求满足，可能需要更详尽的迁移计划以及辅导资源，以维持技术服务和开发效率。

# Summary Table
|  Filename  | Type |    Title    | Status | A  | D  | M  |
|------------|------|-------------|--------|----|----|----|
| [model-lifecycle.md](#item-417f3f) | minor update | 更新模型生命周期文档的日期。 | modified | 1 | 1 | 2 | 
| [quickstart.md](#item-abe5b8) | minor update | 更新自定义命名实体识别快速入门文档的日期。 | modified | 1 | 1 | 2 | 
| [data-formats.md](#item-11da30) | breaking change | 删除自定义文本分析健康数据格式文档。 | removed | 0 | 168 | 168 | 
| [entity-components.md](#item-7620d9) | breaking change | 删除自定义文本分析健康实体组件文档。 | removed | 0 | 106 | 106 | 
| [evaluation-metrics.md](#item-1de45a) | breaking change | 删除自定义文本分析健康评估指标文档。 | removed | 0 | 152 | 152 | 
| [call-api.md](#item-5489c5) | breaking change | 删除自定义文本分析健康API调用文档。 | removed | 0 | 57 | 57 | 
| [create-project.md](#item-4c7376) | breaking change | 删除自定义文本分析健康项目创建文档。 | removed | 0 | 117 | 117 | 
| [deploy-model.md](#item-7bddde) | breaking change | 删除自定义文本分析健康模型部署文档。 | removed | 0 | 105 | 105 | 
| [design-schema.md](#item-6c40e2) | breaking change | 删除自定义文本分析健康项目设计模式文档。 | removed | 0 | 109 | 109 | 
| [fail-over.md](#item-473399) | breaking change | 删除自定义文本分析健康模型的备份和恢复文档。 | removed | 0 | 140 | 140 | 
| [label-data.md](#item-75aad1) | breaking change | 删除自定义文本分析健康数据标记文档。 | removed | 0 | 109 | 109 | 
| [train-model.md](#item-328f92) | breaking change | 删除自定义文本分析健康模型的训练文档。 | removed | 0 | 82 | 82 | 
| [view-model-evaluation.md](#item-463e8a) | breaking change | 删除自定义文本分析健康模型评估文档。 | removed | 0 | 75 | 75 | 
| [get-keys-endpoint-azure.md](#item-6156ce) | breaking change | 删除获取 Azure 密钥和端点的说明文档。 | removed | 0 | 15 | 15 | 
| [cancel-training.md](#item-d752dc) | breaking change | 删除在语言工作室中取消训练作业的说明文档。 | removed | 0 | 11 | 11 | 
| [create-project.md](#item-ba82ba) | breaking change | 删除在语言工作室中创建项目的说明文档。 | removed | 0 | 39 | 39 | 
| [delete-deployment.md](#item-0f0d7c) | breaking change | 删除在语言工作室中删除部署的说明文档。 | removed | 0 | 12 | 12 | 
| [delete-project.md](#item-f5cf6c) | breaking change | 删除在语言工作室中删除项目的说明文档。 | removed | 0 | 15 | 15 | 
| [deploy-model.md](#item-6515b1) | breaking change | 删除在语言工作室中部署模型的说明文档。 | removed | 0 | 28 | 28 | 
| [import-project.md](#item-cd3b25) | breaking change | 删除在语言工作室中导入项目的说明文档。 | removed | 0 | 44 | 44 | 
| [swap-deployment.md](#item-4ed03f) | breaking change | 删除在语言工作室中交换部署的说明文档。 | removed | 0 | 16 | 16 | 
| [test-model.md](#item-f5996f) | breaking change | 删除在语言工作室中测试模型的说明文档。 | removed | 0 | 26 | 26 | 
| [train-model.md](#item-d22149) | breaking change | 删除在语言工作室中训练模型的说明文档。 | removed | 0 | 30 | 30 | 
| [blob-storage-upload.md](#item-52b1f8) | breaking change | 删除关于向 Blob 存储上传文件的快速入门指南。 | removed | 0 | 29 | 29 | 
| [language-studio.md](#item-75ac6e) | breaking change | 删除语言工作室快速入门指南。 | removed | 0 | 81 | 81 | 
| [rest-api.md](#item-218739) | breaking change | 删除 REST API 快速入门指南。 | removed | 0 | 128 | 128 | 
| [resource-creation-azure-portal.md](#item-49304b) | breaking change | 删除 Azure 门户创建资源指南。 | removed | 0 | 39 | 39 | 
| [cancel-training.md](#item-79e31a) | breaking change | 删除取消训练作业的 API 指南。 | removed | 0 | 35 | 35 | 
| [create-project.md](#item-c32223) | breaking change | 删除创建自定义文本分析项目的 API 指南。 | removed | 0 | 72 | 72 | 
| [delete-deployment.md](#item-3551ec) | breaking change | 删除删除部署的 API 指南。 | removed | 0 | 36 | 36 | 
| [delete-project.md](#item-139027) | breaking change | 删除删除项目的 API 指南。 | removed | 0 | 31 | 31 | 
| [deploy-model.md](#item-92e68f) | breaking change | 删除模型部署的 API 指南。 | removed | 0 | 52 | 52 | 
| [export-project.md](#item-7970cf) | breaking change | 删除项目导出的 API 指南。 | removed | 0 | 51 | 51 | 
| [get-deployment-status.md](#item-7b9bdc) | breaking change | 删除部署状态查询的 API 指南。 | removed | 0 | 46 | 46 | 
| [get-export-status.md](#item-467cd8) | breaking change | 删除导出状态查询的 API 指南。 | removed | 0 | 64 | 64 | 
| [get-import-status.md](#item-2dec2c) | breaking change | 删除导入状态查询的 API 指南。 | removed | 0 | 31 | 31 | 
| [get-project-details.md](#item-9ec8e1) | breaking change | 删除项目详细信息查询的 API 指南。 | removed | 0 | 45 | 45 | 
| [get-results.md](#item-7a7625) | breaking change | 删除自定义实体识别任务结果查询的 API 指南。 | removed | 0 | 289 | 289 | 
| [get-training-status.md](#item-787844) | breaking change | 删除模型训练状态查询的 API 指南。 | removed | 0 | 60 | 60 | 
| [import-project.md](#item-6fa50e) | breaking change | 删除导入标签文件的 API 指南。 | removed | 0 | 185 | 185 | 
| [model-evaluation.md](#item-65d73e) | breaking change | 删除模型评估结果的 API 指南。 | removed | 0 | 133 | 133 | 
| [project-details.md](#item-443b56) | breaking change | 删除项目详细信息 API 指南。 | removed | 0 | 57 | 57 | 
| [submit-task.md](#item-393d79) | breaking change | 删除提交任务 API 指南。 | removed | 0 | 86 | 86 | 
| [swap-deployment.md](#item-b2677f) | breaking change | 删除交换部署 API 指南。 | removed | 0 | 54 | 54 | 
| [train-model.md](#item-ce039c) | breaking change | 删除训练模型 API 指南。 | removed | 0 | 66 | 66 | 
| [use-pre-existing-resource.md](#item-c35be9) | breaking change | 删除现有资源使用指南。 | removed | 0 | 65 | 65 | 
| [language-support.md](#item-416183) | breaking change | 删除自定义文本分析的语言支持指南。 | removed | 0 | 45 | 45 | 
| [add-deployment.png](#item-b13093) | breaking change | 删除自定义文本分析部署相关的图片。 | removed | 0 | 0 | 0 | 
| [connect-storage.png](#item-6ae9de) | breaking change | 删除自定义文本分析存储连接图。 | removed | 0 | 0 | 0 | 
| [create-project.png](#item-a58210) | breaking change | 删除自定义文本分析项目创建的图示。 | removed | 0 | 0 | 0 | 
| [deploy-model.png](#item-cd9164) | breaking change | 删除自定义文本分析模型部署的图示。 | removed | 0 | 0 | 0 | 
| [development-lifecycle.png](#item-4dca20) | breaking change | 删除自定义文本分析开发生命周期的图示。 | removed | 0 | 0 | 0 | 
| [file-upload-screen.png](#item-314ce4) | breaking change | 删除文件上传界面的图示。 | removed | 0 | 0 | 0 | 
| [learned-component.png](#item-74afb1) | breaking change | 删除学习组件的图示。 | removed | 0 | 0 | 0 | 
| [list-component.png](#item-e9952e) | breaking change | 删除列表组件的图示。 | removed | 0 | 0 | 0 | 
| [prebuilt-component.png](#item-ea83f3) | breaking change | 删除预构建组件的图示。 | removed | 0 | 0 | 0 | 
| [resource-sharing.png](#item-732a75) | breaking change | 删除资源共享的图示。 | removed | 0 | 0 | 0 | 
| [select-custom-feature-azure-portal.png](#item-7dfe20) | breaking change | 删除选择自定义功能的图示。 | removed | 0 | 0 | 0 | 
| [separated-overlap-example-1-part-2.svg](#item-7488c7) | breaking change | 删除分离重叠示例的SVG图像。 | removed | 0 | 22 | 22 | 
| [separated-overlap-example-1.svg](#item-68315c) | breaking change | 删除分离重叠示例的SVG图像1。 | removed | 0 | 14 | 14 | 
| [storage-screen.png](#item-4dd51e) | breaking change | 删除存储屏幕图像。 | removed | 0 | 0 | 0 | 
| [tag-options.png](#item-0597c4) | breaking change | 删除标签选项图像。 | removed | 0 | 0 | 0 | 
| [test-model-results.png](#item-15ad58) | breaking change | 删除测试模型结果图像。 | removed | 0 | 0 | 0 | 
| [train-model.png](#item-fb48a4) | breaking change | 删除训练模型图像。 | removed | 0 | 0 | 0 | 
| [union-overlap-example-1-part-2.svg](#item-f266f5) | breaking change | 删除联合重叠例子图像。 | removed | 0 | 10 | 10 | 
| [union-overlap-example-1.svg](#item-52bda8) | breaking change | 删除联合重叠示例图像。 | removed | 0 | 13 | 13 | 
| [union-overlap-example-2-part-2.svg](#item-6faae8) | breaking change | 删除联合重叠示例图像2的部分内容。 | removed | 0 | 10 | 10 | 
| [union-overlap-example-2.svg](#item-331137) | breaking change | 删除联合重叠示例图像2。 | removed | 0 | 14 | 14 | 
| [overview.md](#item-6f599b) | breaking change | 删除自定义健康文本分析概述文档。 | removed | 0 | 79 | 79 | 
| [quickstart.md](#item-5bcba3) | breaking change | 删除自定义健康文本分析快速入门文档。 | removed | 0 | 50 | 50 | 
| [glossary.md](#item-f2ab66) | breaking change | 删除自定义健康文本分析术语表文档。 | removed | 0 | 69 | 69 | 
| [service-limits.md](#item-b62cd6) | breaking change | 删除自定义健康文本分析服务限制文档。 | removed | 0 | 93 | 93 | 
| [index.yml](#item-c9444f) | minor update | 更新语言服务索引文件，移除自定义健康文本分析概述链接。 | modified | 0 | 3 | 3 | 
| [overview.md](#item-f138b4) | minor update | 更新语言服务概述，移除自定义健康文本分析部分。 | modified | 0 | 12 | 12 | 
| [data-formats.md](#item-b252b4) | breaking change | 移除自定义情感分析数据格式文档。 | removed | 0 | 103 | 103 | 
| [call-api.md](#item-54966c) | breaking change | 移除如何调用自定义情感分析 API 的文档。 | removed | 0 | 56 | 56 | 
| [create-project.md](#item-7699a8) | breaking change | 移除创建自定义情感分析项目的文档。 | removed | 0 | 117 | 117 | 
| [deploy-model.md](#item-435eeb) | breaking change | 移除自定义情感分析模型部署的文档。 | removed | 0 | 104 | 104 | 
| [design-schema.md](#item-f66944) | breaking change | 移除自定义情感分析数据准备和架构定义的文档。 | removed | 0 | 51 | 51 | 
| [label-data.md](#item-a91115) | breaking change | 移除自定义情感分析数据标记的文档。 | removed | 0 | 75 | 75 | 
| [train-model.md](#item-2b8047) | breaking change | 移除自定义情感分析模型训练的文档。 | removed | 0 | 86 | 86 | 
| [quickstart.md](#item-32972e) | breaking change | 移除自定义情感分析快速入门文档。 | removed | 0 | 45 | 45 | 
| [overview.md](#item-831fe6) | minor update | 更新情感分析与意见挖掘的概述文档。 | modified | 6 | 44 | 50 | 
| [toc.yml](#item-12f1f0) | minor update | 更新情感分析和意见挖掘的目录配置文件。 | modified | 58 | 158 | 216 | 
| [prompt-flow.md](#item-22c24b) | minor update | 更新提示流教程的日期。 | modified | 1 | 1 | 2 | 
| [serp-api-tool.md](#item-144ed7) | minor update | 更新SERP API工具的连接和日期信息。 | modified | 7 | 10 | 17 | 
| [serp-api-tool.png](#item-2a4be2) | minor update | 更新Serp API工具的图片文件。 | modified | 0 | 0 | 0 | 
| [serp-connection-keys.png](#item-50b509) | new feature | 新增Serp连接密钥的图片文件。 | added | 0 | 0 | 0 | 
| [serp-custom-connection-keys.png](#item-e22fae) | breaking change | 删除Serp自定义连接密钥的图片文件。 | removed | 0 | 0 | 0 | 
...
```json
{
    ...
    "modification_title": "更新模型生命周期文档的日期。"
}
```

### Explanation
此代码差异主要涉及对文档 `model-lifecycle.md` 的更新时间戳进行了更新。原日期为“2024年1月16日”，现已更改为“2025年1月31日”。此更新不影响文档的结构或内容，只是单纯的日期修改。此类修改有助于确保用户获取到最新的信息和时间相关的内容。
...
{
    "modification_type": "minor update",
    "modification_title": "更新自定义命名实体识别快速入门文档的日期。"
}
```

### Explanation
此次代码差异显示对 `quickstart.md` 文档的更新时间进行了更新。原日期为“2023年12月19日”，现已更改为“2025年1月31日”。这一修改确保文档中的日期信息是最新的，尽管此次更改不涉及文档的其他内容或结构，因此对用户的实际使用没有影响。
...
```json
{
    ...
    "modification_title": "删除自定义文本分析健康数据格式文档。"
}
```

### Explanation
此次代码差异显示，路径为 `data-formats.md` 的文档已被删除，导致168行内容被移除。这意味着与自定义文本分析健康相关的数据格式的说明和指导不再可用。此变化可能会影响开发者和用户的工作流程，因为他们无法获取有关如何正确格式化数据以导入自定义文本分析的必要信息。这项删除可能是由于内容更新、合并或策略更改引起的，因此用户需要寻求其他资源以获取相关信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康实体组件文档。"
}
```

### Explanation
此次代码差异显示，路径为 `entity-components.md` 的文档已被删除，导致106行内容被移除。这项删除意味着有关自定义文本分析健康实体组件的定义、类型及其使用方法之前提供的详细信息现已不再可用。该文档曾涵盖实体的不同组件类型，如学习组件、列表组件和预构件组件，并阐述了如何利用这些组件提取信息。此变更可能会对用户的开发体验造成影响，因为他们缺乏对如何有效使用实体组件和处理预测重叠的方法的指导。用户需要寻找其他支持材料或更新后的文档来获取这些信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康评估指标文档。"
}
```

### Explanation
此次代码差异显示，路径为 `evaluation-metrics.md` 的文档已被删除，导致152行内容被移除。这项删除意味着有关自定义文本分析健康模型的评估指标的说明、计算方法及相关示例不再可用。这些指标包括准确率（Precision）、召回率（Recall）和F1分数（F1 Score），这些都是评估模型性能的重要标准。该文档不仅提供了模型评估的具体计算方法，还详述了如何通过混淆矩阵分析模型的准确性及改进建议。此变更可能会让用户在评估和优化模型性能时遇到困难，因此他们需要寻找其他资源来获取相关的评估指导和信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康API调用文档。"
}
```

### Explanation
此次代码差异显示，路径为 `call-api.md` 的文档已被删除，导致57行内容被移除。该文档曾提供有关如何向自定义文本分析健康模型发送请求的指导，包括使用预测API进行查询、测试已部署模型的方法以及获取资源密钥和终端的说明。删除这一文档将使用户失去对如何有效调用自定义模型的系统性理解，这可能会影响他们在Azure上使用自定义文本分析功能的能力，因此用户需要寻找其他资源以获取相关的信息和指导。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康项目创建文档。"
}
```

### Explanation
此次代码差异显示，路径为 `create-project.md` 的文档已被删除，导致117行内容被移除。该文档曾详细描述如何创建自定义文本分析健康项目，包括创建Azure资源的先决条件、连接存储账户的步骤以及使用Language Studio和REST API创建项目的具体指导。删除这一文档将使用户失去关于如何有效设置和管理自定义文本分析项目的详细信息，这可能会导致新用户无法顺利入门或完全利用Azure的相关功能，因此他们需要寻找替代资源以获取建立项目所需的知识和指导。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康模型部署文档。"
}
```

### Explanation
此次代码差异显示，路径为 `deploy-model.md` 的文档已被删除，导致105行内容被移除。该文档曾详细介绍如何部署自定义文本分析健康模型，包括部署前的先决条件、模型分配的方法以及使用Language Studio和REST API进行模型部署的步骤。此外，文档中还提到如何在不同环境中交换和删除部署，以及如何管理多个区域的部署等关键操作。删除这一文档将使用户失去重要的参考资料，可能会导致在使用Azure模型部署中的困惑和不便，因此用户需要寻找其他替代资源以获取所需的指导和信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康项目设计模式文档。"
}
```

### Explanation
此次代码差异显示，路径为 `design-schema.md` 的文档已被删除，导致109行内容被移除。该文档曾详细介绍如何选择和准备数据，以成功创建自定义文本分析健康项目，并阐述了设计模式的重要性。文档中明确了如何定义实体类型、避免歧义、选择高质量数据和数据准备的步骤。此外，它还介绍了如何通过Language Studio为项目添加实体，创建数据集，以及如何定义测试集等操作。删除此文档可能会使用户在制作自定义模型时缺乏必要的指导，从而影响项目的成功实施，因此他们需要寻求其他资源来填补信息的缺失。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康模型的备份和恢复文档。"
}
```

### Explanation
此次代码差异显示，路径为 `fail-over.md` 的文档已被删除，导致140行内容被移除。该文档原本详细介绍了如何备份和恢复自定义文本分析健康模型，包括在出现区域性故障时的故障转移设计，使用不同区域的Azure AI语言资源进行项目复制的步骤，以及如何使用导出和导入API同步模型。文档中还提供了有关导出项目资产、导入新项目、训练模型和部署模型的具体指导。此外，它还强调了保持项目同步的重要性，以确保在主区域故障时，备用区域能够提供相似的模型性能。删除该文档将使用户在处理模型备份和故障恢复时缺乏关键指导，可能会对业务连续性造成影响，因此用户需要寻找其他资源以获取必要的信息和支持。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康数据标记文档。"
}
```

### Explanation
此次代码差异显示，路径为 `label-data.md` 的文档已被删除，导致109行内容被移除。该文档原本详细介绍了如何在Language Studio中标记数据，以使模型能够识别和提取定义的实体类型。文档强调了数据标记在开发生命周期中的重要性，并提供了标记数据的先决条件、指南和步骤。此外，它包括有关如何使用API导入已标记数据的信息，以及提醒用户注意标记的精确性、一致性和完整性。删除此文档可能会使用户在执行数据标记时缺乏必要的指导，导致模型训练的效果受到影响，因此用户需要寻找其他资源以获得相关支持和信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康模型的训练文档。"
}
```

### Explanation
此次代码差异显示，路径为 `train-model.md` 的文档已被删除，导致82行内容被移除。该文档原本详细介绍了如何训练自定义文本分析健康模型，包括培训过程中的准备条件、数据划分的要求、以及如何启动和监控训练任务。文档中说明，训练是基于已标记数据的过程，并提供了训练设置的最佳实践和模型评估的方法。它还指出用户可以选择自动分割训练集和测试集或手动进行分割，以确保模型在训练和评估时有适当的样本。删除此文档将使用户在执行模型训练方面缺乏必要的指导，增加了训练过程中出错的可能性，因此用户需要寻找其他来源来获取相关的训练信息和支持。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析健康模型评估文档。"
}
```

### Explanation
此次代码差异显示，路径为 `view-model-evaluation.md` 的文档已被删除，导致75行内容被移除。该文档原本详细介绍了如何查看和评估自定义文本分析健康模型的性能，包括已提取的实体及其相关的评估指标。文档中提到，在模型训练完成后，用户可以查看测试集中文档的模型表现，并注意到不同训练模型的评估结果可能因测试集的随机选择而异。为了确保每次训练模型时评估结果的一致性，文档建议用户使用手动分割训练和测试数据。删除此文档可能导致用户在理解和评估其模型性能时缺乏必要的指导，增加了对模型评估过程的不确定性，因此用户需要寻求其他来源以获取相关的评估信息和支持。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除获取 Azure 密钥和端点的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `get-keys-endpoint-azure.md` 的文档已被删除，导致15行内容被移除。该文档原本提供了在 Azure 门户中获取 API 请求所需的密钥和端点的具体步骤。用户需要访问其资源概述页面，然后从侧边菜单选择“密钥和端点”以获取相关信息，并配有说明性的截图。删除此文档将使用户在寻找 Azure 服务密钥和端点信息时缺乏指导，从而可能导致在进行 API 请求时遇到困惑或错误。因此，用户需要依赖其他文档或来源来了解如何获得所需的密钥和端点信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中取消训练作业的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `cancel-training.md` 的文档已被删除，导致11行内容被移除。该文档原本为用户提供了在语言工作室中取消训练作业的具体步骤，指导用户如何访问训练作业页面、选择要取消的训练作业并使用顶部菜单中的“取消”选项。删除此文档可能会给用户带来不便，使他们难以找到关于如何取消训练作业的指引，尤其是在遇到需要中途取消训练的情况时。因此，用户可能需要寻求其他文档或信息来源来获取相应的操作指导。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中创建项目的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `create-project.md` 的文档已被删除，导致39行内容被移除。该文档原本提供了在语言工作室中创建一个新项目的详细步骤，包括如何登录、选择语言资源、创建新项目、输入项目信息以及连接存储账户等操作。删除此文档将使用户在创建项目时缺乏必要的指引，从而可能导致在项目设置过程中的混淆或错误。因此，用户需要寻求其他文档或资源来获取相应的操作说明，以确保能够顺利创建和管理他们的项目。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中删除部署的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `delete-deployment.md` 的文档已被删除，导致12行内容被移除。该文档原本为用户提供了在语言工作室中删除一个部署的具体步骤，指导用户如何访问部署页面、选择要删除的部署并从顶部菜单中选择“删除部署”选项。删除此文档可能会导致用户在需要删除部署时缺乏必要的指导，从而增加了操作的复杂性和不确定性。用户需要寻找其他文件或资源来获取相关信息，以确保能够正确处理部署的删除操作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中删除项目的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `delete-project.md` 的文档已被删除，导致15行内容被移除。该文档原本详细介绍了如何在语言工作室中删除不再需要的项目，提供了选择语言服务功能、选择要删除的项目以及从顶部菜单中选择“删除”选项的具体步骤。删除此文档意味着用户将失去有关如何正确操作的指引，从而可能在面对项目删除时感到困惑或不确定。用户需要查找其他信息来源以获得相关的操作指导，以确保能够顺利且正确地删除项目。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中部署模型的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `deploy-model.md` 的文档已被删除，导致28行内容被移除。该文档原本详细描述了如何在语言工作室中部署模型的步骤，包括选择“部署模型”菜单、添加新部署、创建新部署及其相关选项。文档中还包含了图像说明，提供了直观的界面指导，以及对现有部署的覆盖说明。此外，文档还提到部署成功后的过期日期问题，帮助用户了解模型的可用性。删除此文档将使用户在进行模型部署时失去关键的指导信息，可能导致操作不当。因此，用户需借助其他资源或文档来获取相关的部署流程，以确保部署操作能够顺利进行。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中导入项目的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `import-project.md` 的文档已被删除，导致44行内容被移除。该文档原本详细介绍了如何在语言工作室中导入项目的具体步骤，包括登录语言工作室、创建新项目、连接存储账户、输入项目信息以及选择数据集等操作。文档中还包含了一些注意事项和小提示，以帮助用户更顺利地完成项目设置。此外，文档还提供了对界面的截图说明，以便用户能够直观理解操作流程。删除此文档意味着用户将失去关于如何有效进行项目导入的重要指导，可能在实施时出现问题，影响工作效率。因此，用户需要查找其他来源的信息来获取操作指导，确保能够顺利导入项目。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中交换部署的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `swap-deployment.md` 的文档已被删除，导致16行内容被移除。该文档原本简要描述了如何在语言工作室中进行部署交换的步骤，包括在“部署模型”页面选择两个要交换的部署，并从顶部菜单中选择“交换部署”选项。此过程的移除意味着用户将失去关于如何灵活管理和切换模型部署的重要指导，可能会导致用户在进行模型管理时面临困难。因此，用户需寻找其他文档或资源，以确保能够获取此功能的操作流程，从而有效管理其模型部署。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中测试模型的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `test-model.md` 的文档已被删除，导致26行内容被移除。该文档原本详细介绍了如何通过语言工作室测试已部署的模型，包括如何选择要测试的部署、输入文本或上传文件、运行测试以及查看结果等步骤。文本中还涉及了如何查看提取的实体及其类型，以及相应的JSON响应信息。此外，文档中还附有测试结果界面的截图，便于用户理解操作流程。删除此文档意味着用户失去了关于如何验证和评估模型性能的重要指导，可能导致在模型测试过程中出现障碍。因此，用户需要寻求其他信息来源，以确保能够顺利完成模型测试，并有效地进行模型优化和调整。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除在语言工作室中训练模型的说明文档。"
}
```

### Explanation
此次代码差异显示，路径为 `train-model.md` 的文档已被删除，导致30行内容被移除。该文档原本提供了从语言工作室开始训练模型的详细步骤，包括如何选择训练作业、启动新的训练作业、选择数据分割方法以及查看训练进度等关键信息。文中还强调了覆盖现有模型的不可逆性及其对已部署模型的影响，并提供了相关操作的截图，便于用户理解过程。此外，文档中对训练职位的状态、进度及注意事项也进行了说明。删除此文档意味着用户失去了一份关于如何有效进行模型训练的重要指导，可能导致用户在进行模型训练时遇到困难。因此，用户需要寻找其他信息来源，以确保能够顺利开展模型训练，提升模型的性能。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除关于向 Blob 存储上传文件的快速入门指南。"
}
```

### Explanation
此次代码差异显示，路径为 `blob-storage-upload.md` 的文档已被删除，导致29行内容被移除。该文档原本描述了在创建 Azure 存储账户并连接到语言资源之后，如何上传样本数据集中的文档到容器根目录的步骤。这些文档后续将用于模型训练。文中详细列出了上传文档所需的步骤，包括下载样本数据集、提取文件、导航到 Azure 门户、创建容器以及上传文件的具体操作。此外，文档中还提到了样本数据集的内容，包括12个临床记录以及包含的医疗实体和治疗位置的信息。删除此文档意味着用户失去了关于如何在 Azure Blob 存储中有效上传数据以进行模型训练的指导，这可能会导致他们在进行项目时感到困惑。因此，用户需要寻找其他信息来源，以便能够继续进行数据上传并有效地进行模型训练。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除语言工作室快速入门指南。"
}
```

### Explanation
此次代码差异显示，路径为 `language-studio.md` 的文档已被删除，导致81行内容被移除。该文档原本包含了使用自定义医疗文本分析的快速入门指南，包括创建 Azure AI 语言资源和存储账户的前提条件、上传示例数据、创建自定义项目、训练模型、部署模型以及测试模型的详细步骤。此外，文档还提供了整合的链接和提示，帮助用户在不同步骤中解决可能遇到的问题，从而顺利地完成从创建资源到测试模型的整个过程。删除此文档意味着用户失去了一个系统性指导，可能导致新用户在使用 Azure AI 和文本分析工具时遇到障碍。因此，用户需要寻找其他资源或文档，以填补这个信息空缺，从而确保他们能够有效地进行模型训练和部署。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除 REST API 快速入门指南。"
}
```

### Explanation
此次代码差异显示，路径为 `rest-api.md` 的文档已被删除，导致128行内容被移除。该文档原本详细介绍了如何使用自定义文本分析的 REST API，包括创建 Azure AI 语言资源和存储账户的步骤、上传示例数据、获取资源密钥和端点、创建分析项目、触发项目导入任务、训练模型、部署模型、生成预测以及清理资源等操作。文中提供了各种操作的具体步骤、API 调用示例，以及如何检查作业状态等重要信息。此外，文档中还包含了额外问题解决链接，以便用户在遇到问题时进行咨询和修复。删除此文档意味着用户将失去一个全面的使用指导，这可能会导致在利用 REST API 进行自定义文本分析时面临困扰。因此，用户需要寻找其他信息渠道，以确保继续有效地使用这些 API 功能进行数据处理和模型部署。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除 Azure 门户创建资源指南。"
}
```

### Explanation
此次代码差异显示，路径为 `resource-creation-azure-portal.md` 的文档已被删除，导致39行内容被移除。该文档原本详细介绍了如何通过 Azure 门户创建新的 Azure AI 语言资源的步骤，包括登录 Azure 门户、选择自定义功能、输入资源详细信息以及审核和创建资源的具体流程。文中还包含了创建资源时所需的信息表格，以及在遇到权限问题时如何联系 Azure 订阅拥有者的注意事项。此外，文档强调了通过选择与语言资源相同区域的存储账户以减少延迟的重要性。删除此文档意味着用户将失去一个实用的创建指南，可能导致他们在使用 Azure 门户进行资源创建时遇到困难。因此，用户需要通过其他文档或资源来获取相关信息，以确保能够顺利地创建和配置 Azure 语言服务资源。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除取消训练作业的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `cancel-training.md` 的文档已被删除，导致35行内容被移除。该文档原本提供了如何通过发送 POST 请求来取消训练作业的详细说明，包括请求的 URL、所需的请求头和 JSON 主体。文中列出了请求的具体格式、必填字段及其示例值，以确保用户能够正确地构建 API 请求。删除此文档意味着用户将失去取消训练作业的指导，可能会对模型训练的管理和控制造成困扰。用户在未来的操作中需要寻找其他替代性文档或资源，以获取信息，确保他们仍能够有效地使用 API 进行训练作业的管理。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除创建自定义文本分析项目的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `create-project.md` 的文档已被删除，导致72行内容被移除。该文档原本提供了有关如何创建自定义文本分析项目的详细步骤，包括所需的 PATCH 请求 URL、请求头、JSON 主体及其示例值。用户在文中可以了解到项目的命名方式、有效的 API 版本及如何在请求正文中指定项目名称、语言代码、项目类型和其他参数。文档还指出了如果缺少适当的存储账户权限会导致请求失败的情况。删除此文档意味着用户将失去一个重要的指南，可能对创建和管理自定义文本分析项目带来困扰。用户需要寻找其他文档或资源以获取相关信息，确保他们可以顺利进行项目的创建和管理。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除删除部署的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `delete-deployment.md` 的文档已被删除，导致36行内容被移除。该文档原本详细描述了如何通过发送 DELETE 请求来删除一个部署，包括请求的 URL、所需的请求头和相应的 JSON 主体。用户可以在文中找到如何格式化请求 URL、替换占位符、以及认证请求所需的关键头信息。此外，文档还说明了成功请求后将收到的响应状态码（202），以及如何借助 `Operation-Location` header 检查操作状态。删除此文档意味着用户将失去对删除部署操作的指导信息，可能影响他们的操作流程。用户需要寻找其他文档或资源来替代，以确保可以顺利进行部署管理。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除删除项目的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `delete-project.md` 的文档已被删除，导致31行内容被移除。该文档原本提供了有关如何通过发送 DELETE 请求来删除项目的详细步骤，包括请求的 URL、所需的请求头和相应的 JSON 主体。用户可以在文中找到格式化请求 URL 的示例，了解如何替换占位符，以及认证请求所需的关键头信息。此外，文档还说明了成功请求后将收到的响应状态码（202），并解释了如何使用 `Operation-Location` header 检查操作的状态。删除此文档意味着用户将失去关于项目删除操作的重要指导信息，可能影响他们管理项目的流程。因此，用户需要寻找其他文档或资源来获取相关信息，以确保顺利进行项目的删除和管理。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除模型部署的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `deploy-model.md` 的文档已被删除，导致52行内容被移除。该文档原本详细描述了如何通过发送 PUT 请求来提交模型部署作业，包括请求的 URL、所需的请求头和相应的 JSON 主体。在文档中，用户可以找到如何替换请求 URL 中的占位符，并提供了所需的参数值示例。例如，用户需要替换 `{ENDPOINT}`、`{PROJECT-NAME}`、`{DEPLOYMENT-NAME}` 和 `{API-VERSION}` 的实际值。此外，该文档还说明了请求体中需包含的 JSON 格式，以及如何提取响应头中的 `operation-location` 值以检查请求的状态。删除此文档意味着用户将失去提交模型部署的重要指导信息，可能会对其工作流程产生影响。因此，用户需要寻找其他可以替代的文档或资源，以便继续顺利进行模型的部署。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除项目导出的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `export-project.md` 的文档已被删除，导致51行内容被移除。该文档原本详细介绍了如何通过发送 POST 请求来导出项目，包括请求的 URL、所需的请求头和请求体的 JSON 格式。在文中，用户可以看到如何替换 URL 中的占位符，如 `{ENDPOINT}`、`{PROJECT-NAME}` 和 `{API-VERSION}`，并提供了示例值。此外，文档还提供了请求头信息，特别是如何使用 `Ocp-Apim-Subscription-Key` 来认证请求。请求体则明确了要导出的资产信息，并说明了如何通过异步方式获取导出作业的状态。删除此文档表示用户将失去关于项目导出操作的关键指导信息，可能会对项目的管理和操作产生负面影响。因此，用户需要寻找其他替代性资源，以帮助他们继续进行项目的导出。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除部署状态查询的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `get-deployment-status.md` 的文档已被删除，导致46行内容被移除。该文档原本提供了如何通过发送 GET 请求来查询部署作业状态的详细指导，包括请求的 URL 格式、所需的请求头以及预期的响应体格式。用户可以在文档中找到如何替换 URL 中的占位符，如 `{ENDPOINT}`、`{PROJECT-NAME}`、`{DEPLOYMENT-NAME}`、`{JOB-ID}` 和 `{API-VERSION}`，并且每个参数都有相应的示例值。此外，文档还说明了如何使用 `Ocp-Apim-Subscription-Key` 来认证请求，并描述了将收到的响应体的结构，这对于了解作业的当前状态（如 "running"、"succeeded" 等）至关重要。删除此文档将使用户失去查询部署状态的重要指导信息，可能影响他们监控和管理模型部署的能力。因此，用户需要寻找其他替代文档或资源，以便继续顺利开展对应的工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除导出状态查询的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `get-export-status.md` 的文档已被删除，导致64行内容被移除。该文档原本提供了如何通过发送 GET 请求来查询导出项目资产状态的详细信息，包括请求的 URL 格式、所需的请求头以及预期的响应体格式。用户可以在文档中找到关于如何替换 URL 中占位符的指导，如 `{ENDPOINT}`、`{PROJECT-NAME}`、`{JOB-ID}` 和 `{API-VERSION}`；每个参数都有示例值。此外，文档详细描述了认证请求所需的请求头信息，以及如何理解响应体中的数据，包括导出作业的状态、生成时间、过期时间和可能的错误信息。删除此文档将使用户失去关于如何查询导出状态的重要指导，可能会影响他们跟踪导出过程及结果的能力，因此用户需要寻找其他替代文档或资源，以便继续进行相关工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除导入状态查询的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `get-import-status.md` 的文档已被删除，导致31行内容被移除。该文档原本提供了如何通过发送 GET 请求来查询导入项目状态的详细说明，包括请求的 URL 结构、占位符的使用说明以及如何进行请求头的身份验证。文档中详述了需要替换的占位符，如 `{ENDPOINT}`、`{PROJECT-NAME}`、`{JOB-ID}` 和 `{API-VERSION}`，并给出了每个参数的示例值。此外，它还强调了使用 `Ocp-Apim-Subscription-Key` 认证请求的重要性。由于该文档的删除，用户将失去关于如何查询导入状态的重要信息，这可能会影响他们管理和监控导入过程的能力。因此，用户需要寻找其他文献或资源来获取相应的指导，以确保能够持续进行相关工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除项目详细信息查询的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `get-project-details.md` 的文档已被删除，导致45行内容被移除。该文档原本提供了如何通过发送 GET 请求来获取项目详细信息的指导，包括请求的 URL 格式、占位符的说明以及请求头的认证信息。文档详细介绍了需要替换的占位符，例如 `{ENDPOINT}`、`{PROJECT-NAME}` 和 `{API-VERSION}`，并给出了示例值。此外，文档还包括如何通过使用 `Ocp-Apim-Subscription-Key` 进行请求的认证，以及预期的响应体格式，其中包含项目的创建时间、最后修改时间、类型、描述和语言代码等信息。由于该文档的删除，用户将失去关于如何获取项目详细信息的重要指导，这可能会影响他们对项目状态的监控和管理。因此，用户需要寻找其他资源来满足这些需求，以确保能够继续进行相关工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义实体识别任务结果查询的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `get-results.md` 的文档已被删除，导致289行内容被移除。该文档原本详细介绍了如何通过发送 GET 请求查询自定义实体识别任务的状态和结果。内容包括请求的 URL 结构、占位符的说明，以及请求中需要包含的认证头信息。文档还介绍了响应体的格式和各个字段的含义，例如创建时间、作业名称、过期时间、状态、任务详情等。

在响应示例中，用户能够看到如何理解返回的 JSON 结构，其中包括提取实体的详细信息，如实体的类别、文本、置信度分数，以及与实体相关的关系等。这些信息对于用户分析和使用自定义模型的结果至关重要。

由于该文档的删除，用户将失去获取自定义实体识别任务结果的重要指导，这可能会影响他们对模型输出的理解与分析。因此，用户需要寻找替代资源以继续其工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除模型训练状态查询的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `get-training-status.md` 的文档已被删除，导致60行内容被移除。该文档原本提供了如何通过发送 GET 请求来查询模型训练进度的详细说明，包括请求的 URL 格式、占位符的定义及示例值。此外，文档还包含了需要在请求头中使用的认证信息以及预期的响应体格式。

响应示例中展示了如何解析返回的 JSON 数据，其中包括模型名称、训练配置版本、预计结束时间、训练状态等信息，这些内容对于用户监控模型训练进度至关重要。删除此文档后，用户将失去获取和理解模型训练进度的重要指导，这可能会影响他们在模型开发和调整过程中的决策和效率。因此，用户需要寻找其他替代资源来补充这些信息，以便继续其相关工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除导入标签文件的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `import-project.md` 的文档已被删除，导致185行内容被移除。该文档原本提供了如何通过发送 POST 请求导入标签文件的详细说明，包括请求的 URL 格式、请求头的认证信息以及请求体中的 JSON 格式。文档中还说明了导入时的注意事项，例如如果项目名称重复，则现有数据将被替换。

导入请求的 JSON 示例中规定了各种必要的字段，包括项目名称、项目类型、描述、语言代码等，还包括实体和文档的结构。用户在发送请求后，可以收到一个 `202` 响应，以指示作业已成功提交，同时提供了如何查询导入作业状态的信息。

文档的删除将影响用户对标签文件导入过程的理解和实施，这可能会导致他们在使用自定义文本分析服务时遇到困难。因此，用户需寻找其他替代文档或资源来帮助完成相应的 API 请求。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除模型评估结果的 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `model-evaluation.md` 的文档已被删除，导致133行内容被移除。该文档原本提供了如何通过发送 GET 请求获取已训练模型评估摘要的详细步骤，包括请求的 URL 格式、所需的认证头信息以及预期的响应体结构。

文档中包含了请求的占位符解释（例如，`{ENDPOINT}`、`{PROJECT-NAME}`等），以及如何解析返回的 JSON 数据，其中举例了 `confusionMatrix`、`entities` 等评估指标。此类信息对于用户理解模型在实际应用中的表现具有重要意义，包括准确度、召回率等关键反馈。

由于该文档的删除，用户将失去对模型评估过程的指导，这可能会影响他们对模型性能的监控与调整。因此，用户需要寻找替代文档以获取相关信息，从而继续有效地使用模型评估功能。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除项目详细信息 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `project-details.md` 的文档已被删除，导致57行内容被移除。该文档原本提供了如何通过发送 GET 请求获取项目详细信息的说明，包括请求的 URL 格式、所需的认证头和返回的 JSON 响应结构。

文档中详细解释了请求的占位符（例如，`{ENDPOINT}`、`{PROJECT-NAME}`）及其示例值，同时介绍了如何解析响应体中的字段，包括项目创建时间、最后修改时间、项目类型等。用户获取这些信息对管理和维护其项目至关重要，特别是在涉及多语言支持的情况下。

由于该文档的删除，用户将失去对获取项目详细信息过程的指导，可能会影响他们对项目相关信息的访问，进而影响项目的管理和使用。因此，用户需要寻找替代文档或资源以获取类似功能的指导。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除提交任务 API 指南。"
}
```

### Explanation
此次代码差异表明，路径为 `submit-task.md` 的文档已被删除，导致86行内容被移除。该文档原本提供了如何通过发送 POST 请求来启动自定义文本分析健康提取任务的详细指南，包括请求的 URL 结构、所需的认证头信息、请求体中的文档格式以及预期的响应。

文档涵盖了请求参数的占位符（如 `{ENDPOINT}`、`{API-VERSION}` 与 `{PROJECT-NAME}`）以及如何构建请求体，包含多个文档的信息和任务细节。它也描述了如何解析 API 响应，特别是在任务提交后如何获取任务状态的 URL。

由于该文档的删除，用户将失去对启动文本分析任务过程的指导，可能导致用户在实际使用过程中无法顺利发起和管理分析任务。因此，用户需要寻找替代资源来获得相关功能的指引，以确保能继续高效地使用该 API。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除交换部署 API 指南。"
}
```

### Explanation
此次代码差异显示，路径为 `swap-deployment.md` 的文档已被删除，导致54行内容被移除。该文档原本详细说明了如何通过发送 POST 请求来启动交换部署作业，包括请求的 URL 格式、所需的认证头信息以及请求体的 JSON 结构。

文档中提供了请求参数的占位符（例如 `{ENDPOINT}`、`{PROJECT-NAME}` 和 `{API-VERSION}`），并描述了如何构建请求体，包含两个部署的名称，这些信息对于切换生产和测试环境中的模型部署至关重要。

由于该文档的删除，用户将失去关于如何启动交换部署作业的指导，这可能对用户在部署和管理模型时造成困扰，尤其是在需要频繁调整或测试不同模型版本的情况下。因此，用户需要寻找替代文档或资源来获取类似的功能说明，以确保能够继续有效地使用相关 API。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除训练模型 API 指南。"
}
```

### Explanation
此次代码差异表明，路径为 `train-model.md` 的文档已被删除，导致66行内容被移除。该文档原本详细指导用户如何通过发送 POST 请求来提交训练作业，包括请求的 URL 格式、所需的认证头信息及请求体的结构。

文档中包含了请求参数的占位符（如 `{ENDPOINT}`、`{PROJECT-NAME}` 和 `{API-VERSION}`），并提供了请求体的 JSON 格式，说明了如何指定模型名称、配置版本及数据划分选项，包括训练集和测试集的比例。它还强调了在训练完成后如何获取作业的状态信息。

由于该文档的删除，用户将失去关于如何提交训练作业的指导，可能影响到用户在模型训练和部署过程中的操作。因此，用户需要寻找替代的文档或其他资源以获得相似功能的说明，以确保其能够继续有效地实现自定义文本分析模型的训练。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除现有资源使用指南。"
}
```

### Explanation
此次代码差异显示，路径为 `use-pre-existing-resource.md` 的文档已被删除，导致65行内容被移除。该文档原本提供了有关如何使用现有的语言资源来启动自定义命名实体识别（NER）的一系列步骤和要求。

文档详细描述了使用现有资源的必要条件，包括资源所处的区域、定价等级以及管理身份的启用设置。此外，该文档还说明了如何在 Azure 门户和 Language Studio 中启用身份管理，确保用户能够正确配置其资源使用。

删除的文档还包含了如何启用自定义文本分析功能的步骤，包括连接 Azure 存储帐户、确保必需的角色已添加以及设置跨源资源共享（CORS）以允许特定请求。这些信息对用户在使用自定义文本分析工具时至关重要。

由于该文档的删除，用户将面临失去这一关键使用指南的困境，可能影响其部署和管理语言资源的能力。因此，用户需要寻找替代的文档或其他资源，以确保他们能够继续有效地利用现有资源进行自定义文本分析。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析的语言支持指南。"
}
```

### Explanation
此次代码差异显示，路径为 `language-support.md` 的文档已被删除，导致45行内容被移除。该文档原本详细介绍了自定义文本分析对于健康领域所支持的语言和地区，提供了用户在使用该服务时所需的重要信息。

文档中包括了关于多语言选项的说明，阐述了用户如何在一个语言中训练模型并在其他语言中提取实体，简化了项目管理的复杂性。此外，它还说明了在不同语言之间添加和训练数据的策略，以提高模型的性能，特别是在使用主要语言为英语的情况下。

此外，该文档列举了支持的文件格式及其对应的语言代码，包括英语、法语、德语、西班牙语、意大利语、葡萄牙语和希伯来语等。通过删除这一指导文档，用户将失去关于如何在自定义文本分析中实现语言支持的关键信息，可能影响其模型训练和数据处理的能力。

用户需要寻找替代资源以获取相似的信息，确保能够继续有效地利用自定义文本分析功能，尤其是在多语言环境下的应用。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析部署相关的图片。"
}
```

### Explanation
此次代码差异显示，路径为 `add-deployment.png` 的图片已被删除。尽管此次删除未涉及任何文本修改或新增内容，但该图片可能是在自定义文本分析服务的文档中提供的图示，旨在帮助用户理解如何进行相关部署。

作为教学材料的一部分，视觉辅助工具通常对于用户理解复杂的过程至关重要，尤其是在进行技术设置时。通过删除这张图片，用户将失去对部署过程的可视化指导，可能会导致他们在实施自定义文本分析时面临更多挑战。

因此，用户可能需要寻找替代的示意图或其他形式的说明，以确保能够顺利进行相关的配置和部署工作。这一删除可能会影响文档的完整性和用户体验。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析存储连接图。"
}
```

### Explanation
此次代码差异表明，名为 `connect-storage.png` 的图片已被删除。这张图片原本用于说明如何连接存储服务，可能是在自定义文本分析 for 健康服务文档中起到辅助引导作用。

视觉材料通常对用户理解某一过程至关重要，尤其是在涉及复杂设置时。通过删除这张连接存储的示意图，用户在完成存储连接的过程中可能会失去一个重要的参考工具，增加了理解和实施相关操作的难度。

因此，用户可能需寻找其他图示或文档以获得类似的指导，以确保他们能够正确地设置和连接存储服务。这一删除可能会影响文档的便利性和用户体验，尤其是对于新用户而言。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析项目创建的图示。"
}
```

### Explanation
此次代码差异显示，名为 `create-project.png` 的图片已被删除。这张图片原本用于展示如何在自定义文本分析服务中创建项目的步骤，这对于用户理解过程和正确实施操作至关重要。

视觉内容通常能够极大地帮助用户快速掌握复杂的流程，尤其是在涉及到创建和配置新项目时。一旦该图示被删除，用户在参考文档进行项目创建时将可能面临缺乏可视化指导的问题，可能导致理解上的困难。

因此，用户需要寻找其他的资源或指引，以弥补失去的视觉帮助，从而确保他们能够顺利完成项目创建的任务。这一删除可能对用户体验产生负面影响，尤其是对于刚接触相关服务的新手用户。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析模型部署的图示。"
}
```

### Explanation
此次代码差异表明，名为 `deploy-model.png` 的图片已被删除。该图片曾用于说明如何在自定义文本分析服务中部署模型的过程，这对于用户开展模型部署工作提供了必要的可视化支持。

删除此图示后，用户在进行模型部署时可能会缺少重要的视觉指导，导致关键步骤的理解和执行变得更加困难。特别是对于新用户或不熟悉此流程的用户而言，缺乏直观的参考资料可能会显著降低他们的操作效率和成功率。

为了弥补这一缺失，用户可能需要寻找替代的文档或资源，以确保他们能够顺利完成模型部署任务。这一变化可能会对用户的总体体验产生负面影响，显著增加学习和操作的复杂度。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义文本分析开发生命周期的图示。"
}
```

### Explanation
此次代码差异显示，名为 `development-lifecycle.png` 的图片已被删除。这张图片原本用于展示自定义文本分析服务的开发生命周期，使用户能够直观地理解在开发过程中各个阶段的协调与继承关系。

删除这一图示后，用户在理解开发流程时将会缺乏可视化的支持，这可能导致对整个生命周期的掌握变得困难。特别是对于初学者而言，缺失这一重要的视觉指导可能会影响他们对各个步骤和阶段之间关系的认识，从而影响他们的学习和应用效率。

用户可能需要依赖其他文档或资源来补充这部分信息，以确保他们能够准确把握开发过程中的关键环节。这一删除潜在地对用户体验造成负面影响，特别是在教育和指导新用户方面。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除文件上传界面的图示。"
}
```

### Explanation
该代码差异表明，名为 `file-upload-screen.png` 的图像已被删除。此图像曾用于展示自定义文本分析服务中的文件上传界面，帮助用户理解如何在该服务中正确地上传文件并开始工作。

删除这一图示后，用户将失去一个重要的视觉参考，有可能导致在文件上传过程中产生困惑。这对于初次使用该服务的用户尤为重要，因为缺少清晰的图示可能使他们无法顺利完成上传过程，进而影响对整个文本分析工作的进展。

为了克服这一缺失，用户可能需要依赖附加文档或教程来获得相关信息，确保他们能掌握文件上传的步骤。此删除将对用户体验产生负面影响，特别是在指导新用户适应服务流程方面。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除学习组件的图示。"
}
```

### Explanation
此次代码差异显示，名为 `learned-component.png` 的图片已被删除。这张图像原本用于展示自定义文本分析中的学习组件，帮助用户理解如何通过学习模型来增强文本分析的准确性和效果。

删除这一图示之后，用户将缺乏一个重要的可视化工具，可能会导致对学习组件功能的理解变得模糊。这对于需要掌握如何利用学习组件来优化分析过程的用户尤为重要，因为缺少形象化的说明可能会影响他们的学习与使用效率。

为弥补这一缺失，用户可能需要查阅其他文档或借助额外的教程来获得相关信息，从而确保他们能够准确理解和应用学习组件的概念。该修改可能对用户体验造成负面影响，特别是在引导新用户理解关键功能方面。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除列表组件的图示。"
}
```

### Explanation
此代码差异表明，名为 `list-component.png` 的图片已经被移除。这张图像原本用于展示自定义文本分析中的列表组件，旨在帮助用户理解如何组织和管理分析结果。

删除该图示将导致用户失去一个重要的视觉指导工具，可能使他们在使用列表组件时更加困惑。这一组件对于希望按结构化方式查看分析结果的用户来说尤为关键，尤其是在处理大量信息时，缺少清晰的视觉指引可能会影响他们的操作效率和整体体验。

为了克服这一缺失，用户可能需要查找其他文档或教程以获取足够的信息，确保能够理解和正确使用列表组件的功能。这一修改可能对于引导新用户理解该功能产生负面影响，因此在后续更新中需要重视该组件的说明与展示。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除预构建组件的图示。"
}
```

### Explanation
在此次代码差异中，显示名为 `prebuilt-component.png` 的图像已被删除。此图像曾作为展示自定义文本分析中预构建组件的工具，帮助用户了解如何利用这些现成的功能来简化分析过程。

删除这一图示意味着用户将失去一个重要的理解工具，可能会对他们利用预构建组件的能力产生负面影响。预构建组件对于快速实现和有效应用文本分析非常关键，缺乏相应的视觉说明可能导致用户在使用这些功能时出现疑问，进而影响他们的学习曲线及操作效率。

为了弥补这一信息缺失，用户可能需要查看其他相关文档或寻求额外的支持来获得充分的理解。这一修改可能会对新用户的引导产生一定的挑战，因此建议在未来的更新中考虑添加相应的说明或示例以提升用户体验。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除资源共享的图示。"
}
```

### Explanation
在这一代码差异中，名为 `resource-sharing.png` 的图像已被删除。该图像原先用于展示自定义文本分析中的资源共享功能，帮助用户理解如何在项目中分享和利用分析结果。

这一删除意味着用户将失去一个重要的视觉参考，可能会对他们理解和实施资源共享功能造成困扰。资源共享是提高团队协作和效率的关键，其缺乏清晰的说明和示例可能会让用户在实际操作中感到无所适从，特别是在面对庞大数据或复杂功能时。

为了应对这一变更，用户可能需要寻求额外的文档资源或指导来确保他们能够有效地使用资源共享功能。考虑到这一修改可能会影响用户的学习体验和工作效率，后续更新中建议重新考虑如何提供该功能的解释和示例，以改善用户的理解和操作体验。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除选择自定义功能的图示。"
}
```

### Explanation
在此次代码差异中，名为 `select-custom-feature-azure-portal.png` 的图像已经被删除。这个图像曾用于指导用户如何在 Azure 门户中选择自定义功能，帮助用户理解在自定义文本分析过程中的操作步骤。

图像的删除可能会对用户造成一定影响，尤其是在新用户或不熟悉流程的用户中，他们可能需要此视觉支持来准确理解和操作 Azure 门户的相关功能。缺少了这一图示，用户在执行此项任务时可能会感到迷茫，影响他们的整体使用体验和效率。

为补救这一信息缺失，建议后续版本中提供详细的文字说明或更新其他图示，以确保用户可以继续顺利进行自定义功能的选择。同时，引导用户通过其他渠道获取支持也是十分重要的，以减少因缺乏视觉指导而造成的疑惑和不便。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除分离重叠示例的SVG图像。"
}
```

### Explanation
在此次代码差异中，名为 `separated-overlap-example-1-part-2.svg` 的 SVG 图像被删除。该图像原本用于展示在自定义文本分析中分离重叠的示例，有助于用户理解如何在处理相关功能时可视化数据的分离与重叠情况。

图像的删除将影响到用户的学习和理解，因为没有了这种可视化工具，用户在掌握如何进行分离重叠分析时可能会面临更多挑战。尤其是在处理复杂数据集时，图像能够提供更直观的理解而文字描述往往难以替代。

为了弥补这一缺失，未来版本中可能需要添加文字描述或替代的可视化工具，帮助用户理解这些复杂概念。同时，可以考虑提供链接到其他资源或示例，以便用户在有需要的情况下寻求进一步的帮助和指导。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除分离重叠示例的SVG图像1。"
}
```

### Explanation
此次代码差异涉及名为 `separated-overlap-example-1.svg` 的 SVG 图像被删除。该图像用于展示在自定义文本分析中分离重叠的示例，为用户提供了具体的可视化参考，帮助他们理解如何在处理文本时分析和分离重叠信息。

该图像的删除可能会对用户的学习和应用造成影响，特别是对于那些依赖可视化辅助来理解复杂数据关系的用户。失去了这一图像，用户可能会碰到更多理解上的障碍，尤其在处理文本分析或数据分离时。

为了减少此变更带来的负面影响，建议在未来的版本中考虑替代的示例图像或文字说明，以确保用户能够继续理解相关主题。同时，提供额外的资源或培训材料，将有助于用户获取更多信息，从而弥补图形支持的缺失。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除存储屏幕图像。"
}
```

### Explanation
在此次代码差异中，包含在 `custom-text-analytics-for-health` 主题下的 `storage-screen.png` 图像被删除。这张图像可能用于展示与存储相关的功能或界面，为用户提供了具体的视觉参考，有助于理解存储服务的操作或使用情境。

图像的删除可能导致用户在查找有关存储服务的资料时缺乏必要的可视化支持，影响他们的学习体验或实施效果。为了减少这一影响，建议在后续更新中考虑替代的图形资源或增强文字描述，以便用户能够补充缺失的信息并更好地掌握相关内容。

同时，若有情境适用的其他图像或示例，提供这些资源也能为用户提供更完整的资料，使得他们能够顺利进行自定义文本分析的相关操作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除标签选项图像。"
}
```

### Explanation
此次代码差异显示 `tag-options.png` 图像在 `custom-text-analytics-for-health` 主题下被删除。这张图像用于展示标签选项的设置或操作方式，帮助用户理解如何在自定义文本分析中有效使用标签功能。

图像的删除会影响用户获取有关标签使用方法的直观指导，可能使他们在实施标签分类或管理时遭遇困难。为了减轻此变更带来的负面影响，建议在后续的版本中提供替代的视觉材料或详细的文字说明，让用户能够在没有图像支持的情况下仍能了解相关操作。

此外，若有标记设置的示例，提供这些信息将进一步帮助用户掌握自定义文本分析的功能，以便他们顺利有效地进行文本标记工作。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除测试模型结果图像。"
}
```

### Explanation
在此次代码差异中，`test-model-results.png` 图像被删除，该图像原本用于展示自定义文本分析服务中的模型测试结果。这张图像为用户提供了关于如何评估和理解模型输出的重要视觉信息。

图像的移除可能导致用户在尝试理解测试结果或评估模型性能时缺乏必要的指导。这可能会影响他们对自定义文本分析工具的信任以及后续的使用效果。因此，建议在未来的更新中考虑提供其他相关的信息或资源，以弥补这一视觉内容的缺失。

可以通过详细的文本描述、数据表格或示例来替代图像，帮助用户获得对模型结果的清晰理解，以便他们能够做出更明智的决策并提高分析项目的成功率。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除训练模型图像。"
}
```

### Explanation
此次代码差异显示 `train-model.png` 图像在 `custom-text-analytics-for-health` 主题下被删除。该图像曾用于示范如何进行模型的训练过程，帮助用户理解该过程的重要步骤和设置。

图像的删除可能会对用户理解和执行模型训练流程造成影响，导致他们在没有视觉参考的情况下难以把握关键操作。这一变更可能降低用户体验，尤其对于那些在使用自定义文本分析服务时依赖于视觉指导的初学者。

为了缓解这一影响，建议在未来版本中用文字描述补充训练模型的步骤，或者提供视频教程等其他形式的资源，以确保用户能在进行模型训练时获得足够的指导和支持。同时，确保提供清晰的示例，帮助用户理解和应用训练模型的必要知识。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除联合重叠例子图像。"
}
```

### Explanation
在此次代码差异中，名为 `union-overlap-example-1-part-2.svg` 的图像文件被删除。该图像原本用于展示自定义文本分析服务中，关于联合重叠的示例，为用户提供了相关概念的直观理解。

图像的移除可能会影响用户对该概念的理解，尤其是在解释复杂的视觉信息时。没有此图像，用户可能会对相关过程或结果产生疑惑，可能限制他们更深入的学习和理解。

在后续的更新中，建议考虑用文字说明补充必要的信息，或者提供其他形式的示例，以确保用户能够掌握联合重叠的概念。同时，提供一些实用的实际案例或数据展示，以帮助用户更好地理解相关内容，增强其学习体验。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除联合重叠示例图像。"
}
```

### Explanation
此次代码差异显示名为 `union-overlap-example-1.svg` 的SVG图像文件被删除。该图像原本用于演示自定义文本分析服务中的联合重叠示例，帮助用户理解相关模型和算法的应用。

图像的删除可能会对用户的学习和理解产生不利影响，特别是在涉及到复杂的概念和算法时，缺乏视觉辅助可能使用户难以掌握内容。此外，对于需要利用这些视觉信息以加深理解的用户，缺失的图像资源可能会导致学习进度的停滞。

为了弥补这一缺失，建议在未来以文字和示例代码的形式提供详细解释，同时考虑引入视频教程、图形化示例或交互式学习工具，以帮助用户更好地理解这些概念。此外，确保文档中包含清晰的步骤和关键点，以提高用户在没有图像支持时的学习体验。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除联合重叠示例图像2的部分内容。"
}
```

### Explanation
此次代码差异显示名为 `union-overlap-example-2-part-2.svg` 的SVG图像文件被删除。该图像是一个关于自定义文本分析服务的联合重叠示例，原本被用于帮助用户可视化理解相关的AI服务概念。

图像的删除可能对用户的学习体验产生负面影响，故事情节或处理过程可能在不再有直观视觉支持的情况下变得模糊。对于依赖图形内容以获得理解和启发的用户，缺少图像会影响他们掌握复杂概念的能力。

为减少影响，建议在后续的文档中通过添加详细文字说明和替代示例来补充缺失的信息，确保用户仍能全面理解联合重叠的相关操作和分析过程。此外，可以考虑引入其他形式的视觉内容，如新的图像或交互式示例，以便用户能够更好的理解和应用相关概念。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除联合重叠示例图像2。"
}
```

### Explanation
此次代码差异显示名为 `union-overlap-example-2.svg` 的SVG图像文件被删除。该图像在自定义文本分析服务中的联合重叠示例中发挥了重要的视觉辅助作用，以帮助用户更好地理解相关的AI算法和应用场景。

图像的删除可能会对用户造成较大的影响，特定概念的教学过程中缺少视觉支持可能会导致用户无法全面理解内容。此外，从文档中移除该图像可能会让依赖于图形解释来增强理解的用户面临困难，特别是在处理复杂的计算模型和数据分析时。

为缓解这种影响，建议在后续的文档中通过增强文字描述或添加新示例来替代图像，同时考虑引入更多形式的学习资源，例如互动式教程或视频讲解，以补偿用户在没有图像帮助下的学习需求。确保用户仍能够获得清晰、准确的解释并理解概念的要点，以便有效进行学习和应用。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义健康文本分析概述文档。"
}
```

### Explanation
此次代码差异显示名为 `overview.md` 的文档被删除，该文档提供了关于自定义健康文本分析服务的重要信息和概述。这项服务允许用户建立定制的AI模型，以从非结构化文本（如临床笔记和报告）中提取特定的健康信息。

文档的删除可能显著影响用户的学习与使用体验，特别是对于希望利用自定义健康文本分析功能的开发人员和研究人员来说。用户可能会失去对该服务的理解，包括如何定义其数据、标记信息、训练模型、评估表现及其在医疗领域的应用场景等关键要素。

为减轻潜在的冲击，建议在其他相关文档中补充替代信息，以便用户可以找到有关如何使用自定义健康文本分析的重要指导。同时，维护透明性并在相关位置更新关于服务关闭的通知将有助于用户迁移至其他服务，以防止他们在未来面临不必要的障碍。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义健康文本分析快速入门文档。"
}
```

### Explanation
此次代码差异显示名为 `quickstart.md` 的文档被删除。该文档提供了关于如何快速开始使用自定义健康文本分析服务的重要指导，特别是在为医疗行业的非结构化文本数据创建和训练自定义模型的过程中。

文档的删除将对用户造成显著影响，尤其是对于那些希望快速使用该服务的开发人员和数据科学家而言。他们失去了获取如何设置、使用和训练自定义模型的初步信息，这可能会导致用户在转向其他服务或解决方案时面临障碍。

为了帮助用户应对这一变化，建议提供替代内容或支持资源，例如在其他文档中整合相应的快速入门信息，或引导用户向其他可用的AI模型训练服务过渡。同时，明确传达服务的暂停时间和后续步骤，将有助于用户有效做好准备，避免在服务截止日期到来时出现数据丢失或项目中断的情况。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义健康文本分析术语表文档。"
}
```

### Explanation
此次代码差异显示名为 `glossary.md` 的文档被删除。该文档包含了在使用自定义健康文本分析服务时可能遇到的术语及其定义，包括与实体、模型、准确率、召回率等相关的关键概念。这些术语对于用户理解和有效使用自定义健康文本分析的功能至关重要。

文档的删除将对系统的用户造成显著影响，特别是对于希望深入掌握该服务的开发人员和分析师而言。失去对相关术语的清晰定义，可能导致用户在项目实施和模型训练过程中产生混淆，影响其对服务的理解和使用效率。

为了缓解这种影响，建议在其他文档或资源中整合相关的术语信息，以帮助用户更好地理解和使用该服务。同时，沟通服务即将停止的时间框架，以及指导用户转向其他可用资源，将有助于减轻这个变化对用户的负面影响。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除自定义健康文本分析服务限制文档。"
}
```

### Explanation
此次代码差异显示名为 `service-limits.md` 的文档被删除。该文档详细列出了在使用自定义健康文本分析服务时，涉及的数据和服务限制，包括语言资源的限制、API调用限制、文档限制及命名限制等。这些信息对于用户理解服务的边界和有效管理其资源至关重要。

文档的删除将显著影响用户，尤其是那些依赖于这些限制进行项目规划和实施的开发人员和数据科学家。失去这部分信息可能导致用户在项目实施过程中遇到资源使用超出预期的情况，进而影响项目的顺利推进。

为缓解这种影响，建议在其他相关文档中提供服务限制的信息，并对用户进行有效的通知，帮助他们适应这一变化。此外，提供支持资源或转向其他相关文档的链接可以有效帮助用户在没有该文档的情况下继续顺利开展工作。
...
{
    "modification_type": "minor update",
    "modification_title": "更新语言服务索引文件，移除自定义健康文本分析概述链接。"
}
```

### Explanation
此次代码差异表明在 `index.yml` 文件中进了 minor update，具体、移除了指向自定义健康文本分析概述的链接。原有文件中包含了一个有关“自定义健康文本分析”的概述链接，该链接的删除可能意味着内容的整合或对现有文档结构的优化。

这种改动可能会影响用户在查找自定义健康文本分析相关信息时的便利性，尤其是当用户希望获取概述信息以快速了解该功能时。虽然该链接被移除，但其他文本分析相关内容仍然保留在索引中，用户可以通过查看剩余链接获取到相关信息。

建议在其他文档或指引中明确说明这一更改，以帮助用户适应新的索引结构，并确保必要的内容可以通过其他方式被有效访问。同时，可以考虑保持对相关概念的补充说明，帮助用户更全面地理解自定义文本分析的功能和应用。
...
{
    "modification_type": "minor update",
    "modification_title": "更新语言服务概述，移除自定义健康文本分析部分。"
}
```

### Explanation
此次代码差异显示在 `overview.md` 文件中进行了 minor update，删除了与“自定义健康文本分析”相关的部分，包括图像、描述和相应的链接。这一更改可能是为了简化文档内容或者将相关信息迁移到其他更合适的位置。

该部分的删除可能会影响用户获取有关自定义健康文本分析功能的快速信息和视觉示例的便利性。用户可能会需要额外的查找步骤才能访问这些信息，尤其是在决定使用哪些语言服务功能时。

尽管删除了这部分内容，但其他与语言服务相关的特性仍然保留在文档中，为用户提供了关于服务功能的指引。建议在文档中稍作补充，指明用户可以通过其他文档找到自定义健康文本分析的详细信息。同时，保持对其他相关功能的明确和易于访问的描述，将有助于用户更好地理解和使用语言服务。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除自定义情感分析数据格式文档。"
}
```

### Explanation
此次代码差异表明，在 `data-formats.md` 文件中，移除了关于自定义情感分析所接受数据格式的全部内容。这一更改被标记为 breaking change，因为用户无法再访问有关如何构建和导入自定义情感分析数据所需格式的重要信息。

被移除的内容包括了关于接受的自定义情感分析数据格式的详细描述，包含 JSON 示例、文件要求及一些关键参数的说明。这些信息对于希望创建和导入项目的用户来说至关重要，缺失这些文档用户可能会在配置其数据时遇到困难。

建议为用户提供其他资源或文档链接，以帮助他们了解数据格式要求，以及如何处理情感分析项目的数据。此外，为了避免 confusion，相关文档的移除应在更新说明中明确提及，并解释相关信息如何获取，以帮助用户顺利过渡到新的文档结构。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除如何调用自定义情感分析 API 的文档。"
}
```

### Explanation
此次代码差异表明，在 `call-api.md` 文件中，移除了关于如何发送自定义情感分析请求的完整文档，这一更改被视为 breaking change。这意味着用户将无法访问到有关如何调用已部署的自定义情感分析模型以提取文本实体的重要指南。

被移除的内容包括了如何使用 Prediction API 或者客户端库来查询部署、如何在 Language Studio 中测试模型、以及如何获取资源密钥和端点的步骤说明。这些都是对用户进行自定义情感分析的重要导航信息，缺失这些内容可能导致用户在使用 Azure AI 服务时遇到障碍。

为了帮助用户克服这一障碍，建议提供驱动用户向其他可用资源或文档的链接，以便他们继续进行自定义情感分析的任务。同时在更新说明中，应明确提及此文档的移除，并说明相关 API 的新文档位置或更新。这样可以减少 confusion，并确保用户能顺利找到所需的信息。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除创建自定义情感分析项目的文档。"
}
```

### Explanation
此次代码差异表明，在 `create-project.md` 文件中，移除了关于如何创建自定义情感分析项目的所有详细指导。这一更改属于 breaking change，因为用户将失去一份关键的资源，无法获得有关设置环境、创建项目以及导入数据的具体步骤。

被移除的内容详细描述了创建自定义情感分析项目所需的先决条件，包括 Azure 订阅和 Language 资源的创建过程、连接存储账户的注意事项，以及如何使用不同方法（如 Language Studio 和 REST API）创建项目和导入数据。这些信息对于用户成功使用 Azure AI 服务至关重要，而缺失这些指导内容，可能会对新用户造成困扰，并影响他们的工作流程。

建议提供备选方案或新的资源链接，以帮助用户获取有关创建和管理自定义情感分析项目的最新信息。同时，在更新说明中明确列出此文档的移除及其影响，以便于用户了解并采取必要的应对措施。这将有助于减轻此项更改带来的潜在不便，并确保用户能够继续顺利使用相关功能。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除自定义情感分析模型部署的文档。"
}
```

### Explanation
此次代码差异表明，在 `deploy-model.md` 文件中，移除了关于如何部署自定义情感分析模型的所有详细指导。这一更改被界定为 breaking change，因为这一文档提供了关键的信息，用户在使用 Azure AI 服务时将无法获得关于模型部署的重要步骤，进而影响他们的工作效率。

被移除的内容包括有关部署模型的先决条件（如成功创建项目和上传文本数据）、如何将模型分配到部署、提交部署任务以及获取部署状态的详细说明。此外，文档还描述了如何在不同部署之间进行交换和删除操作的流程，以及如何将项目部署到多个区域的资源分配策略。这些信息对于用户有效地管理和操作其自定义情感分析模型至关重要。

为了缓解此更改带来的影响，建议在更新说明中提供可用的替代资源链接，帮助用户获取有关如何部署和管理自定义情感分析模型的最新信息。同时，清楚地表明该文档的移除以及对用户流程的潜在影响将有助于有效指导用户如何应对这一变更，确保他们能够顺利继续使用相关功能。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除自定义情感分析数据准备和架构定义的文档。"
}
```

### Explanation
此次代码差异表明，在 `design-schema.md` 文件中，移除了关于如何准备数据和定义自定义情感分析模型架构的所有详细指导。这一更改被视为 breaking change，因为用户将失去重要的指南，无法充分了解在构建自定义情感分析模型前所需的数据准备和架构设计步骤。

被移除的内容详细介绍了数据选择和准备过程中应遵循的最佳实践，包括使用真实的示例数据、平衡数据分布、避免重复数据以及确保训练数据的多样性。这些准则对于确保模型的良好表现至关重要。此外，文档中还强调了如何上传训练数据及其格式要求，以及定义测试集的重要性，以计算模型性能的步骤。

失去这些信息将使新用户在创建自定义情感分析项目时面临困难，因此建议在更新说明中提供相关的替代资源和信息，帮助用户获取有关数据准备和架构设计的指导。同时，确保用户了解该文档的移除及其可能带来的影响，有助于他们在未来的项目中采取必要的调整和措施。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除自定义情感分析数据标记的文档。"
}
```

### Explanation
这一代码差异显示，在 `label-data.md` 文件中，关于如何为自定义情感分析项目标记数据的全部内容已被移除。这一更改被识别为 breaking change，因为用户将失去有关数据标记的关键指导，无法有效地准备和训练情感分析模型。

被删除的内容详细说明了标记数据的必要性和步骤，包括在训练模型之前，如何为文档分配情绪标签，以便模型在训练过程中能够正确地学习。同时，文档中还强调了准备数据的先决条件、数据标记的最佳实践以及在使用 Azure Language Studio 进行数据标记时应注意的事项。

此外，移除的内容还包括针对如何在 Language Studio 中标记数据的详细步骤，用户可以通过该平台访问和标记他们的文本文件，从而为训练集和测试集做好准备。没有这些说明，用户可能在标记数据的过程中遇到困难，从而影响其模型的构建和质量。

为了减轻此更改的影响，建议更新说明中提供可用的替代资源和指引，帮助用户在没有该文档的情况下仍能有效标记数据。此外，明确说明文档的移除和对用户流程的潜在影响，将有助于指导用户作出必要调整，确保他们能够顺利进行情感分析项目。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除自定义情感分析模型训练的文档。"
}
```

### Explanation
此次代码差异显示，在 `train-model.md` 文件中，关于如何训练自定义情感分析模型的内容已被完全移除。这一更改被视为 breaking change，因为用户将失去了解到如何进行模型训练的关键步骤和指导，这对成功实施自定义情感分析至关重要。

被删除的内容包括训练模型的必要先决条件、数据划分的说明和训练作业的管理细节。原文中提到，在开始训练之前，标记的文档将被划分为训练集和测试集，每个集具有不同的功能。此外，删除的内容还含有有关如何在 Azure 平台上启动训练作业、获取作业状态以及取消训练作业的具体步骤和 REST API 的调用。

没有这些指导，用户可能无法有效地开始训练过程，从而影响模型的构建和性能评估。建议在更新说明中提供其他资源和指引，帮助用户在缺乏该文档的情况下仍能找到适当的训练方法。同时，确保用户了解该文档的移除及其潜在影响，有助于他们相应地调整自己的项目实施计划，并确保在训练自定义情感分析模型时不受阻碍。
...
{
    "modification_type": "breaking change",
    "modification_title": "移除自定义情感分析快速入门文档。"
}
```

### Explanation
此次代码差异显示，在 `quickstart.md` 文件中，关于如何快速开始自定义情感分析的文档内容已被移除。这一更改被视为 breaking change，因为用户将失去一份重要的入门指导，无法迅速上手自定义情感分析项目。

被删除的内容包括对自定义情感分析预览版的概述、如何创建自定义项目以训练能检测文本情感的模型的指导，以及相关模型的基本定义。文档中还提示了该服务将于2025年1月10日退休，并指示用户在此日期之前迁移至其他服务如 Azure AI 语言的自定义文本分类。

此外，文档还包含了关于如何使用 Azure Language Studio 和 REST API 进行快速入门的链接，以及创建模型后的后续步骤的指导，如如何使用运行时 API 来分类文本，以及有关数据选择、标记数据和训练模型的详细链接。

随着该文档的移除，用户在开始自定义情感分析项目时可能遇到困难，特别是对于新手用户。因此，建议在更新说明中提供替代资源或指南，以帮助用户有效地实现项目目标。同时，也应明确告知用户该文档的移除及其影响，促使他们及时调整自己的学习和开发计划，以确保顺利进行情感分析项目。
...
{
    "modification_type": "minor update",
    "modification_title": "更新情感分析与意见挖掘的概述文档。"
}
```

### Explanation
此次代码差异显示，`overview.md` 文件中关于情感分析和意见挖掘的概述进行了更新和调整。这一更改被视为 minor update，因为虽然有内容的删除和修改，但主要信息和流程未发生重大变化。

在更新中，删除了一些详细信息，例如关于如何创建自定义情感分析项目的具体步骤，包括数据标记、模型训练、性能查看和模型部署等。原本为用户提供的指引被系统性地简化，从而使得文档更加简洁，突出了情感分析和意见挖掘的核心功能以及它们的用途。

此外，文档中的语言进行了小幅修改，以确保表述更加流畅。例如，"多种书面语言"被修改为"各种书面语言"，同时在一些描述中补充了逗号以提高语句的可读性。

尽管内容被删减，文档依然保持了情感分析和意见挖掘的基本介绍，包括其定义及联系。在最终部分，更新仍指向了使用服务的快速入门指南，鼓励用户进一步探索该服务的应用。

总的来说，此次更新使得文档在结构和表述上变得更为简洁有力，但可能会影响一些用户特别是新手在使用该功能时的初始引导，因此建议补充相关资源以便更好地支持用户。
...
{
    "modification_type": "minor update",
    "modification_title": "更新情感分析和意见挖掘的目录配置文件。"
}
```

### Explanation
此次代码差异显示，`toc.yml` 文件中有关情感分析和意见挖掘部分的目录结构进行了调整和更新。这一更改被视为 minor update，因为虽然进行了较大幅度的删除和添加，但整体内容的逻辑和主题仍然保持一致。

在更新中，新增了对“情感分析和意见挖掘快速入门”文档的链接，以便为用户提供直接的开始使用指导。此外，原本包括许多子条目的“预构建”部分被简化，特别是去掉了一些详细的责任使用和数据隐私相关条目。这使得目录整体更加精简，更加集中于核心主题。

具体而言，关于责任使用的部分中的透明度说明链结被更新为指向情感分析和意见挖掘的透明度说明，而不再包括健康分析的透明度说明。这种调整也反映了对用户需求的重新评估，试图通过优化信息结构来提高用户体验。

另外，添加了对容器使用和配置的指引链接，使得用户能够更便捷地查找相关操作指南。这些精简和重组的内容有助于用户快速找到所需的信息，尤其是在学习如何通过不同的 API 和服务进行情感分析和意见挖掘时。

整体而言，此次目录调整是对文件结构和链接的优化，使得文档内容更加聚焦并可读性加强，但仍建议保持关于责任和数据隐私使用的附加资源，以满足不同用户的需求。
...
{
    "modification_type": "minor update",
    "modification_title": "更新提示流教程的日期。"
}
```

### Explanation
此次代码差异显示，`prompt-flow.md` 文件中的日期信息已经更新。此次更改被视为 minor update，因为仅有日期的修改，不涉及内容的实质性变更。

具体而言，文档中的日期从“2024年7月9日”修改为“2025年1月31日”。这一更改可能反映了文件的发布时间进度或是文档更新的计划。通过更新日期，用户可以更清晰地了解最新信息的发布时间，这对于用户查阅教程时了解内容的时效性是非常重要的。

整体来看，此次更新仅涉及文件元数据的调整，没有影响到教程的具体内容或结构。因此，用户在使用该教程时应该不会遇到任何功能上的改变。
...
{
    "modification_type": "minor update",
    "modification_title": "更新SERP API工具的连接和日期信息。"
}
```

### Explanation
此次代码差异显示，`serp-api-tool.md` 文件经历了一些小幅度的修改。作为一个 minor update，此次调整主要集中在连接步骤的描述以及文档的日期信息。

在更新中，文档的日期已从“2024年5月21日”更新为“2025年1月31日”，这反映了文件的更新计划和发布时间点。此外，连接步骤中的某些细节被调整，以提供更明确的指导。例如，用户现在应通过“管理中心”>“概述”访问项目设置，并在“连接的资源”下选择“+ 新连接”，而不是之前的说明。

具体步骤的序号格式均进行了调整，使得表述更加连贯且易于理解。此外，相关截图也进行了更换，以更好地展示如何在 Azure AI Foundry 门户中添加 Serp 连接。这些更改旨在提高用户在设置 Serp API 工具时的体验，并确保步骤清晰易懂。

整体而言，这些更新和微调强化了文档的实用性，使用户能够更顺利地创建和管理与 Serp API 的连接。
...
{
    "modification_type": "minor update",
    "modification_title": "更新Serp API工具的图片文件。"
}
```

### Explanation
在此次代码差异中，`serp-api-tool.png` 图片文件进行了更新。虽然没有添加或删除任何内容，但该文件的修改说明了为改善文档展示效果所做的minor update。

具体来说，这可能意味着原来的图片可能已被替换为更高质量或更相关的版本，虽然变化没有被明确列出。更新图片通常是为了提供用户更清晰的视觉信息，帮助他们更好地理解如何使用 Serp API 工具。

尽管此更新不涉及文本或步骤的改变，但它对用户的整体体验具有重要意义，能够增强文档的视觉质量和专业性。此外，这种对图像的维护和更新是确保技术文档保持现代感和实用性的一个重要方面。
...
```json
{
    ...
    "modification_title": "新增Serp连接密钥的图片文件。"
}
```

### Explanation
此次代码差异表明，新增了名为 `serp-connection-keys.png` 的图片文件。这一新增被归类为 new feature，旨在增强文档内容的可视性和信息传达效果。

该图片的引入预计将为用户提供更直观的指导，特别是在与 Serp API 连接键相关的操作步骤中。通过展示连接密钥相关的视觉信息，用户可以更清晰地了解在设置 Serp 连接时所需填写的内容和配置，这对于新手用户尤其重要。

该图片可以补充文本说明，帮助用户更好地理解如何在 Azure AI Foundry 门户中处理连接密钥，增强用户体验和操作的有效性。这种视觉辅助不仅提高了文档的专业性，也为用户提供了更具体的参考资源，减轻了理解文本说明的负担。
...
{
    "modification_type": "breaking change",
    "modification_title": "删除Serp自定义连接密钥的图片文件。"
}
```

### Explanation
此次代码差异显示，名为 `serp-custom-connection-keys.png` 的图片文件已被删除。这一修改被视为 breaking change，因为移除图像可能会影响依赖于该视觉内容的文档说明或用户理解。

该图片的删除可能是由于其内容不再相关或已经被更高级或更有效的图像所取代。这可能意味着文档的某些部分在与 Serp 自定义连接密钥相关的指导过程进行了重新审视，决定不再需要该可视化信息。

用户在查阅文档时，若依赖于这一图片提供的支持，可以感到困惑或不完整，因此此变动需要在文档的其他部分进行相应的补充说明或替代，以确保用户在执行操作时不会产生理解上的障碍。为了维持信息的完整性和可用性，建议在移除此类图片时，提供新的图像或更新内容来替代该图像所提供的信息。
