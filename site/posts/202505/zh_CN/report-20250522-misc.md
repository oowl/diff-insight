...
summary: |-
  本次代码修改主要集中在三份文档的更新，旨在增加文档智能服务的限制、改善会话语言理解的指导，并更新相关术语以适应最新工具。修改没有引入破坏性变化，但增强了用户的灵活性和使用体验。

  新功能方面，文档智能服务的训练页面数和文档类型限制显著提升，新增了在会话语言理解项目中使用正则表达式的说明，并引入了“Quick Deploy”选项，方便用户在无需训练数据的情况下自定义意图路由。

  更新未引入任何破坏性变化，其他更新包括数据集大小限制提升到2GB，"Language Studio"更名为"AI Foundry"，以及会话语言理解文档结构的重新组织以提高可读性。

  总体来看，此次更新为用户提供了更大的操作空间和更灵活的选项，尤其是对需要处理大规模文档的企业具有重要意义。更新后的说明和结构改善显示了对用户体验的重视，使用户在快速变化的技术环境中保持竞争力。
...
# Highlights
本次代码修改集中在三个文档的更新上，重点是增加文档智能服务的限制，改善会话语言理解的文档指引，并更新了相关术语以适应最新工具。这些修改没有引入破坏性变化，但增强了用户的灵活性和使用体验。

## New features
- 文档智能服务中，训练的最大页面数和文档类型限制有显著提升。
- 增加了如何在会话语言理解项目架构中使用正则表达式组件的说明。
- “Quick Deploy”选项的使用提示被引入，以便用户无需训练数据即可自定义意图路由。

## Breaking changes
没有引入破坏性变化。

## Other updates
- 文档智能服务中，数据集大小限制从1GB增加到2GB。
- “Language Studio”更名为“AI Foundry”以反映新功能。
- 会话语言理解文档的结构和步骤被重新组织以提高可读性。

# Insights
这次更新涉及多个方面的提升，对于用户来说主要带来了更大的操作空间和更灵活的选项。在文档智能服务中，关键限制参数的大幅增加使得用户可以处理更复杂的文档集合，这对需要大规模文档处理的企业尤为有利。

在会话语言理解领域，更新后的架构构建指南和语料标注指引，展示了平台对用户体验的重视。通过详尽的说明和改进后的步骤结构，用户将能够更高效地进行项目开发。此外，工具名称等的更新有利于用户理解平台功能的变化。

总体来看，文档更新为了简化操作流程、增加灵活性和与时俱进的技术更新提供了良好的支持，使用户能够在迅速变化的技术环境中保持竞争力。

# Summary Table
|  Filename  | Type |    Title    | Status | A  | D  | M  |
|------------|------|-------------|--------|----|----|----|
| [service-limits.md](#item-5ceae5) | minor update | 文档智能服务限制更新 | modified | 2 | 2 | 4 | 
| [build-schema.md](#item-623a8b) | minor update | 对会话语言理解项目架构构建指南的修改 | modified | 40 | 36 | 76 | 
| [tag-utterances.md](#item-3d1b2f) | minor update | 会话语言理解中的标注语料更新 | modified | 65 | 61 | 126 | 
...
### Explanation
在这次更新中，修改了《文档智能服务限制》文档中的一些服务限制值。具体来说，训练中的最大页面数（分类器）的限制从10,000页增加到25,000页，而最大文档类型（类）的限制则从500个增加到1,000个。此外，训练数据集的大小限制也有所更改，默认值由1GB提高到2GB。虽然这些更改未引入破坏性变化，但它们提供了更大的灵活性和扩展性，以满足用户对文档智能服务的需求。
...
{
    "modification_type": "minor update",
    "modification_title": "对会话语言理解项目架构构建指南的修改"
}
```

### Explanation
此次修改主要涉及更新《会话语言理解项目架构构建指南》文档的内容和结构。更新中更改了文档标题，以更加准确地反映文档的内容，并调整了作者信息和日期。主要内容中，文档对项目架构的定义进行了细化，同时也对创建意图和实体的步骤进行了重新组织和简化，提高了可读性。此外，加入了关于如何添加正则表达式组件的详细说明，使得用户在构建时可以获得更多的选项和灵活性。这些变更旨在使用户更容易理解如何有效地构建会话语言理解项目的架构。
...
{
    "modification_type": "minor update",
    "modification_title": "会话语言理解中的标注语料更新"
}
```

### Explanation
此次更新主要对《会话语言理解中如何标注语料》文档进行了增补和调整，以适应最新的功能和用户需求。文档中更改了多个术语及工具名称，例如将“Language Studio”替换为“AI Foundry”，以反映该工具的最新名称和功能。同时，文中增加了标注数据的关键性和数据导入的相关提示，提升了用户在进行语音标注时的指导性。

此外，更新还包括对指导步骤的细化，确保用户在进行标注时能够清晰、有效地理解每个步骤。同时新增的提示框提供了有关如何使用“Quick Deploy”选项的建议，帮助用户在无需添加训练数据的情况下实现自定义的意图路由。这些改进旨在增强用户体验，并确保用户在构建和训练会话语言理解模型时拥有最新的信息和支持。
